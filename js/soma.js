...
/*A função somarMatrizes percorre cada posição das matrizes de entrada (matriz A e matriz B) e calcula a soma dos 
valores correspondentes. Os resultados são armazenados na matriz 'soma'.*/
